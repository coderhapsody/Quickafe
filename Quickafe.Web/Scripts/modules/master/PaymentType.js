...
$(function () {
    $("#addEditWindow").kendoWindow(PaymentType.getWindowOptions());
    $("#btnAddNew").click(PaymentType.addNewClick);
    $("#btnDelete").click(PaymentType.deleteClick);
    $("#grid").on("click", ".editRow", PaymentType.editClick);
});