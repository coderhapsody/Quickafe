...
$(function () {
    $("#addEditWindow").kendoWindow(Table.getWindowOptions());
    $("#btnAddNew").click(Table.addNewClick);
    $("#btnDelete").click(Table.deleteClick);
    $("#grid").on("click", ".editRow", Table.editClick);
});