var InventoryOutDetail = (function () {
    var windowOptions = {
        modal: true,
        width: 600,
        height: 350,
    ...
    return {
        ...
        saveClick: function (e) {
            ...
            var validator = $("#addEditForm").kendoValidator(validationOptions).data("kendoValidator");
            if (validator.validate() && InventoryOutDetail.detailEntryIsValid()) {
...
$(function () {
    $("#addEditWindow").kendoWindow(InventoryOutDetail.getWindowOptions());
    $("#btnAddNew").click(InventoryOutDetail.addNewClick);
    $("#btnDelete").click(InventoryOutDetail.deleteClick);
    $("#btnSave").click(Inventory.saveClick);
    $("#grid").on("click", ".editRow", InventoryOutDetail.editClick);
    $("#windowBrowseProduct").kendoWindow(InventoryOutDetail.getWindowBrowseOptions());
    $("body").on("click", "#btnBrowseProduct", InventoryOutDetail.browseProductClick);
});